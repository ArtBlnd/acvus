...
pub fn execute(code: &[u8]) -> VmState {
    ...
    loop {
        ...
        match base {
            ...
            // -- Bank A: ALU ------------------------------
            ADD_A => {
                let v = get_a(rs1, a0, a1, a2, a3).wrapping_add(get_a(rs2, a0, a1, a2, a3));
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            SUB_A => {
                let v = get_a(rs1, a0, a1, a2, a3).wrapping_sub(get_a(rs2, a0, a1, a2, a3));
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            MUL_A => {
                let v = get_a(rs1, a0, a1, a2, a3).wrapping_mul(get_a(rs2, a0, a1, a2, a3));
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            DIV_A => {
                let v = get_a(rs1, a0, a1, a2, a3) / get_a(rs2, a0, a1, a2, a3);
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            MOD_A => {
            ...
            NEG_A => {
                let v = (get_a(rs1, a0, a1, a2, a3) as i64).wrapping_neg() as u64;
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            ...
            // -- Bank A: CMP ------------------------------
            EQ_A => {
                let v = (get_a(rs1, a0, a1, a2, a3) == get_a(rs2, a0, a1, a2, a3)) as u64;
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            LT_A => {
            ...
            // -- Bank A: MOV/CONST ------------------------
            MOV_A => {
                let v = get_a(rs1, a0, a1, a2, a3);
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 2;
            }
            CONST_A => {
                let v = read_u64(code, pc + 2);
                set_reg!(rd, v, a0, a1, a2, a3);
                pc += 10;
            }
            ...
            // -- Bank B: ALU ------------------------------
            ADD_B => {
                let v = get_b(rs1, b0, b1, b2, b3).wrapping_add(get_b(rs2, b0, b1, b2, b3));
                set_reg!(rd, v, b0, b1, b2, b3);
                pc += 2;
            }
            SUB_B => {
                let v = get_b(rs1, b0, b1, b2, b3).wrapping_sub(get_b(rs2, b0, b1, b2, b3));
                set_reg!(rd, v, b0, b1, b2, b3);
                pc += 2;
            }
            MUL_B => {
                let v = get_b(rs1, b0, b1, b2, b3).wrapping_mul(get_b(rs2, b0, b1, b2, b3));
                set_reg!(rd, v, b0, b1, b2, b3);
                pc += 2;
            }
            DIV_B => {
                let v = get_b(rs1, b0, b1, b2, b3) / get_b(rs2, b0, b1, b2, b3);
                set_reg!(rd, v, b0, b1, b2, b3);
                pc += 2;
            }
            MOD_B => {
            ...
            NEG_B => {
                let v = (get_b(rs1, b0, b1, b2, b3) as i64).wrapping_neg() as u64;
                set_reg!(rd, v, b0, b1, b2, b3);
                pc += 2;
            }
            ...
            // -- Bank B: CMP ------------------------------
            EQ_B => {
                let v = (get_b(rs1, b0, b1, b2, b3) == get_b(rs2, b0, b1, b2, b3)) as u64;
                set_reg!(rd, v, b0, b1, b2, b3);
                pc += 2;
            }
            LT_B => {
