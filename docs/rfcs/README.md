...
| [RFC-0047](0047-a-slice-is-the-one-thing-the-machine-indexes.md) | A slice is the one thing the machine indexes: `core::as_slice`, `Index`/`IndexSet`, `a[i]`, bounds proved by an interval domain | Accepted |
