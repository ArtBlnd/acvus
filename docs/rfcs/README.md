...
| [RFC-0052](0052-an-operation-is-a-struct-the-machine-calls-once.md) | An operation is a struct the machine calls once: `dyn Op`, straight-line blocks with one terminator, `chunks(4)`, no `Flow`/`Payload`/`OpFn` | Draft |
